...
/**
 * Sample list adapter which displays the coupons.
 *
 * @author Luci
 */
public class CouponAdapter extends BaseAdapter {
    ...
    public CouponAdapter(Context context) {
        ...
        if (!couponsListAsString.equals(SHARED_PREF_NO_ENTRY)) {
            mCouponList = gson.fromJson(couponsListAsString, new TypeToken<List<Coupon>>() {}.getType());
        } else {
    ...
    public View getView(final int position, View convertView, ViewGroup container) {
        ...
        if (rowView == null) {
            ...
            holder.imageView = (NetworkImageView) rowView.findViewById(R.id.coupon_imageview);
            holder.titleTextView = (TextView) rowView.findViewById(R.id.coupon_name);
            holder.descTextView = (TextView) rowView.findViewById(R.id.coupon_desc);
        ...
        OnyxBeaconApplication.loadImageAsync(coupon.imageThumb, holder.imageView);
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (position < mCouponList.size()) {
                    OnyxBeaconApplication.getOnyxBeaconManager(mContext).deleteCoupon(coupon.couponId);
