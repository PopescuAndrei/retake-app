...
public class FragmentMap extends BaseFragment implements
	...
	private void setUpMarkers(CameraPosition position) {
		...
		MarkerOptions EntryMarker = new MarkerOptions().position(polivalentaEntry)
									.title("Dreamhack entrance")
									.visible(true);
		MarkerOptions RetakeMarker = new MarkerOptions()
								...
								.visible(true);
		BigMarkerOptions = new MarkerOptions().position(polivalentaEntry)
				.title("Retake")
				.snippet("We are ready to take over the world!")
				.icon(BitmapDescriptorFactory.fromResource(R.drawable.dreamhackopen));
